...
class Configurator(Ui_Configurator):
	def __init__(self, dialog):
		...
		self.sprites = []
		self.sprites.append(SpriteModelWrapper(self.socketIO, tempSprites[0], [500, 5000]))
		self.sprites.append(SpriteModelWrapper(self.socketIO, tempSprites[1], [500, 5000]))
		self.sprites.append(SpriteModelWrapper(self.socketIO, tempSprites[2], [500, 5000]))
